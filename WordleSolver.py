...
def wordleSolver(possible_words):
    ...
    currBestWord = bestWord(possible_words, letterFreq(possible_words))
    print("Try the word:", currBestWord)
    print("Enter your first result:")
    result = input()
    counter = 1
    while result != "ggggg" and counter < 6:
        possible_words = word_remover(result, currBestWord, possible_words)
...
# List of all 5 letter words in the dictionary
